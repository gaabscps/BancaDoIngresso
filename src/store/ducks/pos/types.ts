...
export enum PosTypes {
  ...
  ACTIVATE_POS_SUCCCES = '@pos/ACTIVATE_POS_SUCCCES',
  ...
  INACTIVATE_POS_REQUEST = '@pos/INACTIVATE_POS_REQUEST',
  INACTIVATE_POS_SUCCCES = '@pos/INACTIVATE_POS_SUCCCES',
  INACTIVATE_POS_FAILURE = '@pos/INACTIVATE_POS_FAILURE',
