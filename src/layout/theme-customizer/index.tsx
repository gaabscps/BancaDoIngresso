...
import { Classe, classes } from '../../data/layouts';
import { ApplicationState } from '../../store';
import { ConfigDbData, ConfigDbDataColor } from '../../data/customizer/config';
import {
  addSidebarSettings,
  addCustomizer,
  addColor,
...
} from '../../store/ducks/customizer/actions';

// eslint-disable-next-line import/no-mutable-exports
let DefaultLayout = {} as Classe;
...
const Themecustomizer = (): JSX.Element => {
  ...
  const configDB = useSelector<ApplicationState, ConfigDbData>(
    content => content.customizer.data.customizer,
  );
  ...
  const { sidebar_setting } = configDB.settings;
  const { mix_background_layout } = configDB.color;
  ...
  const handlePageLayputs = (type: Classe): void => {
    const key = Object.keys(type).pop() as string;
    const val = Object.values(type).pop() as string;
    (document.querySelector('.page-wrapper') as Element).className = `page-wrapper ${val}`;
    dispatch(addSidebarSettings(val));
  ...
  useEffect(() => {
    ...
    const defaultLayoutObj = classes.find(item => Object.values(item).pop() === sidebar_type);
    // somecases taken static url so need to modified
    const modifyURL = `${process.env.PUBLIC_URL}/dashboard/default/${Object.keys(
      defaultLayoutObj as Classe,
    ).pop()}`;
    // fetch id from URL
    const id =
    ...
    DefaultLayout = defaultLayoutObj as Classe;

    handlePageLayputs(layout as Classe);
    dispatch(addCustomizer());
    dispatch(addCustomizer());

    let color = {
      primary_color: default_color as string,
      secondary_color,
    } as ConfigDbDataColor;
    dispatch(addColor(color));
    dispatch(routerAnimation(layout_animation as string));
    ...
    if (width <= 991 && configDB.settings.sidebar.type.split(' ').includes('horizontal-wrapper')) {
      (document.querySelector('.page-wrapper') as Element).className =
      ...
      ).className = `page-wrapper ${configDB.settings.sidebar.type}`;
    ...
    // set sidebar setting
    (document.querySelector('.sidebar-wrapper') as Element).setAttribute(
      'sidebar-layout',
      sidebar_setting,
    );
    // eslint-disable-next-line
  ...
  const openCustomizer = (type: string): void => {
    setActiveTab1(type);
    setRightSidebar(!rightSidebar);
    if (rightSidebar) {
      (document.querySelector('.customizer-contain') as Element).classList.add('open');
      (document.querySelector('.customizer-links') as Element).classList.add('open');
    }
  };

  const closeCustomizer = (): void => {
    setRightSidebar(!rightSidebar);
    (document.querySelector('.customizer-contain') as Element).classList.remove('open');
    (document.querySelector('.customizer-links') as Element).classList.remove('open');
  };

  const handleLayout = (layout: string): void => {
  ...
  const handleSidebarType = (
    ...
    (document.querySelector('.page-wrapper') as Element).className = `page-wrapper ${type}`;
  ...
  const handleSidebarSetting = (
    ...
    e.currentTarget.classList.add('active');
    dispatch(addSidebarSettings(sidebar_setting));
  };

  const handleCustomizerMix_Background = (
    e: MouseEvent<HTMLLIElement, globalThis.MouseEvent>,
  ): void => {
    e.preventDefault();
    ...
    e.currentTarget.classList.add('active');
    dispatch(addMixBackgroundLayout(e.currentTarget.getAttribute('data-attr') as string));
  };

  const selectAnimation = (e: ChangeEvent<HTMLInputElement>): void => {
    localStorage.setItem('animation', e.target.value);
    dispatch(routerAnimation(e.target.value));
    window.location.reload();
  };

  const handleUnlimatedColor1Change = (e: ChangeEvent<HTMLInputElement>): void => {
    const { value } = e.target;
    setColorBackground1(value);
  };
  const handleUnlimatedColor2Change = (e: ChangeEvent<HTMLInputElement>): void => {
    const { value } = e.target;
    setColorBackground2(value);
  };
  const OnUnlimatedColorClick = (): void => {
            ...
            <TabContent activeTab={activeTab1}>
              <TabPane tabId="1">
                ...
                <ul className="sidebar-setting layout-grid">
                  <li
                    ...
                    onClick={e => handleSidebarSetting(e)}
                  >
                    <div className="header bg-light">
                      <ul>
                        <li></li>
                  ...
                  <li data-attr="border-sidebar" onClick={e => handleSidebarSetting(e)}>
                    <div className="header bg-light">
                      <ul>
                        <li></li>
                        <li></li>
                  ...
                  <li data-attr="iconcolor-sidebar" onClick={e => handleSidebarSetting(e)}>
                    <div className="header bg-light">
                      <ul>
                        <li></li>
                        <li></li>
                ...
                <Input
                  type="select"
                  defaultValue={layout_animation as string}
                  name="selectMulti"
                ...
                <ul className="layout-grid customizer-mix">
                  <li
                    ...
                    onClick={e => handleCustomizerMix_Background(e)}
                  >
                    <div className="header bg-light">
                      <ul>
                        <li></li>
              ...
              <TabPane tabId="2">
                <ul className="sidebar-type layout-grid layout-types">
                  <li data-attr="compact-sidebar" onClick={() => handlePageLayputs(classes[0])}>
                  ...
                  <li
                    className="only-body"
                    data-attr="default-body"
                    onClick={() => handlePageLayputs(classes[1])}
                  >
                    <div className="layout-img">
                  ...
                  <li data-attr="modern-layout" onClick={() => handlePageLayputs(classes[2])}>
                    <div className="layout-img">
                      <Media src={nine} className="img-fluid" alt="" />
                      <h6>Seoul</h6>
                    </div>
                  </li>
                  <li data-attr="material-layout" onClick={() => handlePageLayputs(classes[3])}>
                    <div className="layout-img">
                      <Media src={ten} className="img-fluid" alt="" />
                      <h6>Los Angeles</h6>
                    </div>
                  </li>
                  <li ata-attr="dark-sidebar" onClick={() => handlePageLayputs(classes[4])}>
                    <div className="layout-img">
                      <Media src={three} className="img-fluid" alt="" />
                      <h6>Paris</h6>
                    </div>
                  </li>
                  <li data-attr="compact-wrap" onClick={() => handlePageLayputs(classes[5])}>
                    <div className="layout-img">
                      <Media src={four} className="img-fluid" alt="" />
                      <h6>Tokyo</h6>
                    </div>
                  </li>
                  <li data-attr="color-sidebar" onClick={() => handlePageLayputs(classes[6])}>
                    <div className="layout-img">
                      <Media src={five} className="img-fluid" alt="" />
                      <h6>Madrid</h6>
                    </div>
                  </li>
                  <li data-attr="compact-small" onClick={() => handlePageLayputs(classes[7])}>
                    <div className="layout-img">
                  ...
                  <li
                    data-attr="box-layout"
                    className="box-layout"
                    onClick={() => handlePageLayputs(classes[8])}
                  >
                    <div className="layout-img">
                  ...
                  <li data-attr="enterprice-type" onClick={() => handlePageLayputs(classes[9])}>
                    <div className="layout-img">
                      <Media src={eight} className="img-fluid" alt="" />
                      <h6>Singapore</h6>
                    </div>
                  </li>
                  <li data-attr="material-icon" onClick={() => handlePageLayputs(classes[10])}>
                    <div className="layout-img">
                      <Media src={eleven} className="img-fluid" alt="" />
                      <h6>Rome</h6>
                    </div>
                  </li>
                  <li data-attr="advance-type" onClick={() => handlePageLayputs(classes[11])}>
                    <div className="layout-img">
