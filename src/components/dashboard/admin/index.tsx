...
import actionCard from '../../../assets/images/svg/actionCard.svg';
          ...
          <CardHeader className="cardHeader row">
            <div className="firstDiv col">
              <div className="firstContent textContent d-flex align-items-start">
                <img src={clock} style={{ paddingRight: '8px', marginTop: '5px' }} alt="" />
            ...
            <div className="firstDiv col">
              <div className="firstContent textContent d-flex align-items-start">
                <img src={x} style={{ paddingRight: '8px', marginTop: '5px' }} alt="" />
                <div className="d-flex flex-column">
                  Eventos cancelados
            ...
            <div className="firstDiv col">
              <div className="firstContent textContent d-flex align-items-start">
                <img src={money} style={{ paddingRight: '8px', marginTop: '5px' }} alt="" />
                <div className="d-flex flex-column">
                  PDV’s cadastrados
            ...
            <div className="lastDiv col">
              <div className="firstContent textContent d-flex align-items-start">
                <img src={reMoney} style={{ paddingRight: '8px', marginTop: '5px' }} alt="" />
                <div className="d-flex flex-column">
                  Chargeback
                  <div className="count">100</div>
                </div>
              ...
              <div className="partyImage2">
                ...
                <div className="descriptionEvent">
                  ...
                  <div className="dateEvent">
                    <img src={calendar} style={{ paddingRight: '10px' }} alt="" />
                    07/05/2022
                  </div>

                  <div className="locationEvent">
                    <img src={locationPin} style={{ paddingRight: '10px' }} alt="" />
                    Campinas/SP
                  </div>
                </div>
              </div>
