        ...
        <FormGroup>
          <div className="d-flex pt-2">
            <div className="fieldSpacing">
              ...
              <SuperInput id="exampleNumber" placeholder="Digite ou selecione o produto" />
            ...
            <div className="fieldSpacing">
              ...
              <SuperInput style={{ width: '135px' }} id="exampleNumber" placeholder="Ex: 100" />
            </div>
          </div>
          <div className="d-flex pt-2">
            <div className="fieldSpacing" style={{ marginRight: '50px' }}>
              ...
              <SuperInput style={{ width: '135px' }} id="exampleNumber" placeholder="0%" />
            </div>
            <div className="groupButton">
