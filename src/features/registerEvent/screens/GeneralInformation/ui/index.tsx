          ...
          <div className="container-event">
            ...
            <FormGroup className="mb-2">
              <SelectCustom
                ...
                onChange={e => {
                  formGeneralInformation.onChangeFormInput(FormInputName.eventType)(
                    e?.value as string,
                  );
                }}
                error={
            ...
            <FormGroup className="mb-2">
              <InputText
                ...
                error={
                  formGeneralInformation.formErrors.name &&
                  formGeneralInformation.formErrors.name[0]
                }
              />
            </FormGroup>
            <FormGroup className="mb-2">
              ...
              <Col md={6} className="pl-0">
                <FormGroup className="mb-2">
                  <InputText
                    ...
                    onChange={e =>
                      formGeneralInformation.onChangeFormInput(FormInputName.startDate)(
                        e.target.value,
                      )
                    }
                    error={
              ...
              <Col md={6} className="pr-0">
                <FormGroup className="mb-2">
                  <InputText
                    ...
                    onChange={e =>
                      formGeneralInformation.onChangeFormInput(FormInputName.endDate)(
                        e.target.value,
                      )
                    }
                    error={
              ...
              <Col md={6} className="pl-0">
                <FormGroup className="mb-2">
                  <InputText
                    ...
                    onChange={e =>
                      formGeneralInformation.onChangeFormInput(FormInputName.startTime)(
                        e.target.value,
                      )
                    }
                    error={
              ...
              <Col md={6} className="pr-0">
                <FormGroup className="mb-2">
                  <InputText
                    ...
                    onChange={e =>
                      formGeneralInformation.onChangeFormInput(FormInputName.endTime)(
                        e.target.value,
                      )
                    }
                    error={
            ...
            <FormGroup className="mb-2">
              <InputText
                ...
                onChange={e =>
                  formGeneralInformation.onChangeFormInput(FormInputName.facebookUrl)(
                    e.target.value,
                  )
                }
                error={
            ...
            <FormGroup className="mb-2">
              <InputText
                ...
                onChange={e =>
                  formGeneralInformation.onChangeFormInput(FormInputName.instagramUrl)(
                    e.target.value,
                  )
                }
                error={
            ...
            <FormGroup className="mb-2">
              <ButtonGroup
                ...
                onChange={e =>
                  formGeneralInformation.onChangeFormInput(FormInputName.publishWebsite)(
                    e.target.value,
                  )
                }
                options={[
            ...
            <FormGroup className="mb-2">
              <TextArea
                ...
                onChange={e =>
                  formGeneralInformation.onChangeFormInput(FormInputName.ticketPhrase)(
                    e.target.value,
                  )
                }
                error={
